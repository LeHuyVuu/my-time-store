        ...
        http
                ...
                .authorizeRequests(auth -> {
                    auth
                            ...
                            .requestMatchers(HttpMethod.PUT, "/api/v1/cartItems/**").permitAll()
                            .requestMatchers(HttpMethod.DELETE, "/api/v1/cartItems/**").permitAll()

                            .requestMatchers(HttpMethod.POST,"/api/v1/order/**").permitAll()
                            .requestMatchers(HttpMethod.PUT,"/api/v1/order/**").permitAll()
                            .requestMatchers(HttpMethod.DELETE,"/api/v1/order/**").permitAll()
                            .requestMatchers(HttpMethod.GET,"/api/v1/order/**").permitAll()

                            .requestMatchers(HttpMethod.POST,"/api/v1/feedbacks/**").permitAll()
                            .requestMatchers(HttpMethod.PUT,"/api/v1/feedbacks/**").permitAll()
